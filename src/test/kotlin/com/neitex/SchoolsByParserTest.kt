...
internal class SchoolsByParserTest {
    ...
    inner class ClassesDataTests {
        ...
        fun testGettingTimetableValidClassIDValidCredentials() = runBlocking {
            ...
            val timeConstraintsList = listOf(
                ...
                },
                {
                    assertContentEquals(
                        timetable.monday, arrayOf(
                            Lesson(1, timeConstraintsList[1], "Белорусская литература", 8, null),
                            Lesson(2, timeConstraintsList[2], "Белорусский язык", 8, null),
                            Lesson(3, timeConstraintsList[3], "История Беларуси", 8, null),
                            Lesson(4, timeConstraintsList[4], "Математика", 8, null),
                            Lesson(5, timeConstraintsList[5], "Английский язык", 8, null),
                            Lesson(6, timeConstraintsList[6], "Информатика", 8, null),
                        )
                    )
                },
                {
                    assertContentEquals(
                        timetable.tuesday, arrayOf(
                            Lesson(1, timeConstraintsList[1], "Русская литература", 8, null),
                            Lesson(2, timeConstraintsList[2], "Русский язык", 8, null),
                            Lesson(3, timeConstraintsList[3], "Обществоведение", 8, null),
                            Lesson(4, timeConstraintsList[4], "Физика", 8, null),
                            Lesson(5, timeConstraintsList[5], "Физическая культура и здоровье", 8, null)
                        )
                    )
                }, {
                    assertContentEquals(
                        timetable.wednesday, arrayOf(
                            Lesson(2, timeConstraintsList[2], "Всемирная История", 8, null),
                            Lesson(3, timeConstraintsList[3], "География", 8, null),
                            Lesson(4, timeConstraintsList[4], "Биология", 8, null),
                            Lesson(5, timeConstraintsList[5], "Английский язык", 8, null)
                        )
                    )
                }, {
                    assertContentEquals(
                        timetable.thursday, arrayOf(
                            Lesson(3, timeConstraintsList[3], "Математика", 8, null),
                            Lesson(4, timeConstraintsList[4], "Химия", 8, null),
                            Lesson(5, timeConstraintsList[5], "Биология", 8, null),
                            Lesson(6, timeConstraintsList[6], "Информатика", 8, null),
                            Lesson(7, timeConstraintsList[7], "Физическая культура и здоровье", 8, null)
                        )
                    )
                }, {
                    assertContentEquals(
                        timetable.friday, arrayOf(
                            Lesson(2, timeConstraintsList[2], "Математика", 8, null),
                            Lesson(3, timeConstraintsList[3], "Химия", 8, null),
                            Lesson(4, timeConstraintsList[4], "Английский язык", 8, null)
                        )
                    )
                }, {
